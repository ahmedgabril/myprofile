<!-- Footer -->
<footer class="text-center bg-neutral-100 text-neutral-600 dark:bg-neutral-900 dark:text-neutral-200 mt-14">

  <!-- Social media -->
  <div class="flex items-center justify-center p-6 border-b-2 border-neutral-200 dark:border-neutral-500 lg:justify-between">
  ...
  <!-- Main container -->
  <div class="pt-8 pb-4 mx-6 text-center">
  ...
  <form action="">
    <div class="grid items-center justify-center grid-cols-1 gap-5 mb-6 md:grid-cols-3">
      <!-- Sign up text -->
  ...
  <!-- Images -->
  <div class="flex justify-center mb-7 gap-x-5">
  <!-- Image wrapper -->
  <div class="relative w-full overflow-hidden bg-no-repeat bg-cover rounded-lg">
    <img
  ...
  <!-- Image wrapper -->
  <div class="relative hidden w-full overflow-hidden bg-no-repeat bg-cover rounded-lg sm:flex">
    <img
  ...
  <!-- Image wrapper -->
  <div class="relative hidden w-full overflow-hidden bg-no-repeat bg-cover rounded-lg md:flex">
    <img
  ...
  <!-- Copyright -->
  <div class="flex items-center justify-center p-6 text-center bg-neutral-200 dark:bg-neutral-700">
