    ...
    <div class=" {{app()->getLocale() =='en' ? 'ml-auto ':'mr-auto' }}">
      ...
      ">
          <button
            ...
            <img src="{{
             app()->getLocale() == 'en' ?  asset('united.svg') :asset('egypt.svg')}}" width="25" height="25"/> 
          ...
          <ul style="font-family: 'Cairo', sans-serif!important"
            ...
            <li wire:key="{{ $localekey }}">
                ...
                {{-- wire:navigate --}}
                 ...
                 <img src="{{
                  $data['name'] == 'English' ?  asset('united.svg') :asset('egypt.svg')}}" width="25" height="25"/> 
{{      $data['name'] }}
                </a>
            </li>
        @endforeach
